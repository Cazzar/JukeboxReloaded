...
import cazzar.mods.jukeboxreloaded.events.EventHandler;
...
public class CommonProxy {
	...
	public void initItems() {
		...
		GameRegistry.registerItem(kokoro = new ItemCustomRecord(
				config.items.record1, "kokoro", "ココロ", "Sung by Kagamine Rin",
				"writer トラボルタ feat. 鏡音リン"), "kokoro");
		GameRegistry.registerItem(loveIsWar = new ItemCustomRecord(
				config.items.record2, "love_is_war", "Love is War",
				"Sung by Hatsune Miku", "Writer - Supercell feat. 初音ミク"),
				"love_is_war");
		...
		GameRegistry.registerItem(sukiDaiSuki = new ItemCustomRecord(
				...
				"Sung by Kagamine Rin", "Writer - かたほとりP"), "suki_daisuki");
