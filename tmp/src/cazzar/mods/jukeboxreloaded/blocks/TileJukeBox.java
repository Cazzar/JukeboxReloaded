...
import cazzar.mods.jukeboxreloaded.lib.BlockCoord;
...
public class TileJukeBox extends TileEntity implements IInventory
{
    ...
    public void updateEntity()
    {
        ...
        if ( !playing  )
        {
            ...
            if (shuffle && !repeat){
                PacketDispatcher.sendPacketToServer((new PacketShuffleDisk(this)).makePacket());
...
//            packet.sendToServer();
            PacketDispatcher.sendPacketToServer((new PacketJukeboxDescription(this)).makePacket());
        }
    }
