...
import cazzar.mods.jukeboxreloaded.configuration.ConfigurationOption;
...
public class JukeboxReloaded {
    ...
    @ConfigurationOption(category="default", key="jukeboxID", comment="The ID number of the jukebox")
    public int JukeboxID = 3000;
    @ConfigurationOption(category="default", key="enableUpdater", comment="Check for updates?")
    ...
    {
        if (!instance.enableUpdater) return null;
