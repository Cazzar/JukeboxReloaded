...
class LayerIIDecoder extends LayerIDecoder implements FrameDecoder {
	...
	static class SubbandLayer2 extends Subband {
		...
		public static final int		table_ab2_codelength[]			= { 0, 5,
																			7,
																			3,
																			10,
																			4,
		...
		public static final int		table_ab3_codelength[]			= { 0, 5,
																			7,
																			3,
																			10,
																			4,
		...
		public static final int		table_ab4_codelength[]			= { 0, 5,
																			7,
																			16 };
		...
		public static final int		table_cd_codelength[]			= { 0, 5,
																			7,
																			10,
																			4,
																			5,
	   ...
	   */
		...
		public void read_allocation(Bitstream stream, Header header, Crc16 crc) {
			final int length = get_allocationlength(header);
	   ...
	   */
		...
		public boolean read_sampledata(Bitstream stream) {
			if (allocation != 0) if (groupingtable[0] != null) {
				...
				final float[] target = samples;
				final float[] source = groupingtable[0];
				/*
				 * int tmp = 0;
				 * int temp = 0;
	...
	static class SubbandLayer2Stereo extends SubbandLayer2 {
	   ...
	   */
		...
		public boolean put_next_sample(int channels, SynthesisFilter filter1,
				SynthesisFilter filter2) {
			final boolean returnvalue = super.put_next_sample(channels,
					filter1, filter2);
			if ((channel2_allocation != 0)
				...
				if (channels == OutputChannels.BOTH_CHANNELS) filter2
						.input_sample(sample, subbandnumber);
	   ...
	   */
		...
		public boolean read_sampledata(Bitstream stream) {
			...
			if (channel2_allocation != 0) if (groupingtable[1] != null) {
				 ...
				 * temp++;
				 * target[tmp] = source[samplecode + temp];
				 * // memcpy (channel2_samples, channel2_groupingtable +
				 * samplecode, 3 * sizeof (real));
				 */
				final float[] target = channel2_samples;
				final float[] source = groupingtable[1];
				int tmp = 0;
				int temp = samplecode;
				target[tmp] = source[temp];
				temp++;
				...
				channel2_samples[0] = (float) ((stream
						.get_bits(channel2_codelength[0])) * channel2_factor[0] - 1.0);
