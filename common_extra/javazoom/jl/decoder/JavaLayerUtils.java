...
public class JavaLayerUtils {
	 ...
	 *                the underlying stream, or an object could not be
	 *                deserialized
	 *                from the stream.
	 * 
	 ...
	 */
	public static Object deserializeArray(InputStream in, Class elemType,
	...
	public static Object deserializeArrayResource(String name, Class elemType,
			int length) throws IOException {
	...
	public static synchronized InputStream getResourceAsStream(String name) {
		...
		if (hook != null) is = hook.getResourceAsStream(name);
		else {
