...
public class ComputerCraftAPI {
    /**
     * Registers a peripheral handler for a TileEntity that you do not have access to. Only use this if you want to expose
     * IPeripheral on a TileEntity from another mod. For your own mod, just implement IPeripheral on the TileEntity
     * directly.
     *
     * @see IPeripheral
